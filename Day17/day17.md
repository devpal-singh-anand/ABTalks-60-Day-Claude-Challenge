...
- [Demo Files in This Folder](#demo-files-in-this-folder)
...
| File | Description |
|--------|--------|
| `Screenshots/header.png` | Hero section + KPI cards |
| `Screenshots/fuel cost emissions & vehicle age.png` | Charts and age analysis |
| `Screenshots/E85 verdict.png` | E85 score gauge |
...
├── linkedinpost.md
├── Post.png
├── wagonr-fuel-economics-dashboard.html
└── Screenshots/
    ├── header.png
    ├── fuel cost emissions & vehicle age.png
    └── E85 verdict.png
```
