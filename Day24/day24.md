...
|---|---|---|
| AI token costs | Platform pays (scales with users) | User pays (own API keys) |
| Storage costs | Platform pays for DB + backups | User pays (own Drive/OneDrive) |
| Monthly burn at 1,000 users | ₹42-63K | ₹2-3K |
| Monthly burn at 5,000 users | ₹2L+ (unsustainable) | ₹5-8K (sustainable) |
| Primary scaling risk | Financial (token costs) | Operational (founder capacity) |
| Privacy posture | Platform holds all user data | User owns their data |
...
| Check | Result |
|---|---|
| PDF generated successfully | ✅ 759 KB, 15 pages (BYOK/BYOS revised) |
...
| 5 investment scores (community lens) | ✅ Viability 78, Sustainability 72 ▲revised, GTM 74, Competitive 82, Funder 68 |
| BYOK/BYOS architecture advantage | ✅ Dedicated subsection — AI tokens ₹0, storage ₹0, burn stays under ₹10K at 5,000 users |
...
| Honest verdict (not inflated) | ✅ 🟡 VALIDATE COMMUNITY (75/100 BYOK/BYOS revised) — honest, not overhyped |
...
├── strategy.html                                     ← Source HTML for the PDF
└── Screenshots/
...
9. Output: `PrepPal_AI_Business_Strategy_Report.pdf` (19 pages, 57 KB)
